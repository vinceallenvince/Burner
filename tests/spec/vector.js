describe("A Vector", function() {
  ...
  it('VectorAdd() should add two vectors.', function() {
    objA = new Burner.Vector(1, 1);
    expect(Burner.Vector.VectorAdd(obj, objA).x).toEqual(23);
    expect(Burner.Vector.VectorAdd(obj, objA).y).toEqual(11);
  });
  it('add() should add a vector.', function() {
    obj.add(new Burner.Vector(1, 1));
    expect(obj.x).toEqual(23);
    expect(obj.y).toEqual(11);
  });
  it('VectorSub() should subtract two vectors.', function() {
    objA = new Burner.Vector(1, 1);
    expect(Burner.Vector.VectorSub(obj, objA).x).toEqual(21);
    expect(Burner.Vector.VectorSub(obj, objA).y).toEqual(9);
  });
  it('sub() should subtract a vector.', function() {
    obj.sub(new Burner.Vector(1, 1));
    expect(obj.x).toEqual(21);
    expect(obj.y).toEqual(9);
  });
  it('VectorMult() should multiply a vector by a scalar value.', function() {
    expect(Burner.Vector.VectorMult(obj, 2).x).toEqual(44);
    expect(Burner.Vector.VectorMult(obj, 2).y).toEqual(20);
  });
  ...
  it('VectorDiv() should divide a vector by a scalar value.', function() {
    expect(Burner.Vector.VectorDiv(obj, 2).x).toEqual(11);
    expect(Burner.Vector.VectorDiv(obj, 2).y).toEqual(5);
  });
  ...
  it('VectorDistance(v1, v2) should return the distance between two vectors.', function() {
    objA = new Burner.Vector(50, 100);
    objB = new Burner.Vector(100, 100);
    expect(Burner.Vector.VectorDistance(objA, objB)).toEqual(50);
  });
  it('distance() should calculate the distance between this vector and a passed vector.', function() {
    obj = new Burner.Vector(5, 0);
    expect(obj.distance(new Burner.Vector(1, 0))).toEqual(4);
  });
  it('rotate() should rotate a vector using a passed angle in radians.', function() {
    obj = new Burner.Vector(10, 0);
    expect(obj.rotate(Math.PI).x).toEqual(-10);
  });
  it('VectorMidPoint(v1, v2) should return the midpoint between two vectors.', function() {
    objA = new Burner.Vector(50, 100);
    objB = new Burner.Vector(100, 200);
    expect(Burner.Vector.VectorMidPoint(objA, objB).x).toEqual(75);
    expect(Burner.Vector.VectorMidPoint(objA, objB).y).toEqual(150);
  });
  ...
  it('Vector.VectorAngleBetween should return the angle between two Vectors.', function() {
    objA = new Burner.Vector(50, 0);
    objB = new Burner.Vector(50, 180);
    expect(Math.round(Burner.Vector.VectorAngleBetween(objA, objB))).toEqual(1);
  });
});
